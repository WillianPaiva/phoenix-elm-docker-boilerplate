...
var _user$project$App$model = {counters: _elm_lang$core$Array$empty, mdl: _debois$elm_mdl$Material$model};
...
var _user$project$App$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			default:
				return A3(_debois$elm_mdl$Material$update, _user$project$App$Mdl, _p0._0, model);
		}
	});
var _user$project$App$Remove = {ctor: 'Remove'};
var _user$project$App$Add = {ctor: 'Add'};
var _user$project$App$Reset = function (a) {
	return {ctor: 'Reset', _0: a};
};
var _user$project$App$Increase = function (a) {
	return {ctor: 'Increase', _0: a};
};
var _user$project$App$view1 = F2(
	function (idx, val) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			},
			{
				...
				_1: {
					...
					_0: A5(
						...
						_user$project$App$model.mdl,
						{
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$onClick(
								_user$project$App$Increase(idx)),
							_1: {
								ctor: '::',
				...
				_elm_lang$core$Basics$identity,
				{
					...
					_0: {
						...
						_0: A5(
							...
							{
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(_user$project$App$Add),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
					...
					_1: {
						...
						_0: {
							...
							_0: A5(
								...
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$onClick(_user$project$App$Remove),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
